...
![Teradici software client]({{config.baseurl}}/images/teardici_software_client.png)
<!--
...
![Client connection empty]({{config.baseurl}}/images/client_connection_empty.jpeg)
...
![Workstation details]({{config.baseurl}}/images/workstation_details.jpeg)
...
![Client connection completed]({{config.baseurl}}/images/client_connection_completed.jpeg)

Click the **SAVE** button and then the **NEXT** button.

All being well, you will be prompted for your Sherpa **username** and **password**.

![Client username and password]({{config.baseurl}}/images/client_username_and_password.jpeg)
...
![Linux workstation]({{config.baseurl}}/images/linux_workstation.jpeg)
...
![Client saved connection]({{config.baseurl}}/images/client_saved_connection.jpeg)
