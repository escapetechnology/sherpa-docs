...
![Connect Insecurely]({{config.baseurl}}/images/connect-insecurely.png)
...
![Unable to connect]({{config.baseurl}}/images/unable-to-connect.png)
...
![The network connection has been lost]({{config.baseurl}}/images/the-network-connection-has-been-lost.png)
...
![This desktop has no sources available]({{config.baseurl}}/images/this-desktop-has-no-sources-available.png)
...
![You are not entitled to any resource]({{config.baseurl}}/images/you_are_not_entitled.jpeg)
...
![Authentication failed]({{config.baseurl}}/images/authentication-failed.png)
...
![No local account on workstation]({{config.baseurl}}/images/no-local-account-on-workstation.png)
...
![Not been invited]({{config.baseurl}}/images/not-been-invited.png)
...
![The workstation was stopped]({{config.baseurl}}/images/the-workstation-was-stopped.png)
...
![Non-startable state]({{config.baseurl}}/images/non-startable-state.png)
...
![Error 6609]({{config.baseurl}}/images/error-6609.png)

![Error 6405]({{config.baseurl}}/images/error-6405.png)
...
![Delete saved connection]({{config.baseurl}}/images/delete-saved-connection.png)
...
![No available licenses]({{config.baseurl}}/images/no-available-licenses.png)
...
![Error 6610]({{config.baseurl}}/images/error_6610.png)
