...
![Allowed IP addresses](/assets/images/allowed-ip-addresses.png)

A new page will open.

![Project allow list](/assets/images/project-allow-list.png)
...
![Adding an entry in the allow list](/assets/images/adding-an-entry-in-the-allow-list.png)
...
![IP add request saved](/assets/images/ip-add-request-saved.png)

Followed shortly by a _Building_ state.

![IP add request building](/assets/images/ip-add-request-building.png)

And finally a _Built_ state.

![IP add request built](/assets/images/ip-add-request-built.png)
...
![Editing the allow list](/assets/images/editing-the-allow-list.png)
...
![Workstation details users section](/assets/images/workstation-details-users-section.png)

Click on **Invite a new user** to begin adding a new user to the workstation.

![Invite a new user](/assets/images/invite-a-new-user.png)
...
![Invites page](/assets/images/invites-page.png)
...
![Invite hover over](/assets/images/invite-hover-over.png)
...
![Delete a user](/assets/images/delete-a-user.png)
