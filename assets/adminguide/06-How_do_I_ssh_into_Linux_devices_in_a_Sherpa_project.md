...
![Public SSH key](/assets/images/public-ssh-key.png)

When you create a Sherpa project you are encouraged to use an SSH key.

![Add an SSH key](/assets/images/add-an-ssh-key.png)

Click on **Apply an existing key** and select the existing key from the dropdown.

![Apply an existing key](/assets/images/apply-an-existing-key.png)
...
![Add a new key](/assets/images/add-a-new-key.png)
