...
![Create a new project](/assets/images/create-a-new-project.png)
...
![Select-born-in-the-cloud](/assets/images/select-born-in-the-cloud.png)

Give the project a **Name** and select the cloud **Provider**.

![Project name and cloud provider](/assets/images/project-name-and-cloud-provider.png)
...
![Select a location](/assets/images/select-a-location.png)
...
![Workstation build spec](/assets/images/workstation-build-spec.png)
...
![Shared storage](/assets/images/shared-storage.png)

![Render manager](/assets/images/render-manager.png)

![Render node](/assets/images/render-node.png)
...
![Updated estimate](/assets/images/updated-estimate.png)
...
![SSH key selection](/assets/images/ssh-key-selection.png)
...
![Summary page](/assets/images/summary-page-1.png)

Your project will initially go into a **Saved** state.

![Project saved](/assets/images/project-saved.png)

Shortly after it should go into a **Building** state.

![Project building](/assets/images/project-building.png)

After some time it will finish **Building** and go into a **Built** state.

![Project built](/assets/images/project-built.png)
