...
![add-generic-resource](/assets/images/add-generic-resource.png)

Below is an example of a project in which I have built a license server and a monitoring server.

![generic-servers](/assets/images/generic-servers.png)
...
![generic-resource-allow-list](/assets/images/generic-resource-allow-list.png)
