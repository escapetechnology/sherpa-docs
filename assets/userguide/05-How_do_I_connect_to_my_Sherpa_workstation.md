---
layout: default
title: How do I connect to my workstation?
parent: User Guide
nav_order: 5
---
# How do I connect to my workstation?
...
![Teradici software client](/sherpa-docs/assets/images/teardici_software_client.png)
<!--
...
![Downloads and scripts](/sherpa-docs/assets/images/teradici_downloads_and_scripts.png)

Accept the terms and conditions by scrolling to the bottom of the EULA and then clicking the **Agree** button.

![EULA](/sherpa-docs/assets/images/teradici_license_agreement.png)

Click on the **Download now** button to download the application installer to your usual download folder.

![Download now](/sherpa-docs/assets/images/teradici_download_link.png)
-->
Open the downloaded installer and follow the instructions to install the software client on your system.

Additional documentation for the Teradici PCoIP Software Client is available from the Teradici site here:
<https://www.teradici.com/web-help/cas_quickstart_guide/Getting_Started/documentation/#pcoip-clients>

## Connecting to your workstation for the first time
Open the Teradici PCoIP Software Client, if this is the first time you have opened it you may be required to give the software permission to access your file system and microphone.

On first launch you will be presented with a screen asking for a **Host Address or Code** and a **Connection Name**.

![Client connection empty](/sherpa-docs/assets/images/client_connection_empty.jpeg)
...
![Workstation details](/sherpa-docs/assets/images/workstation_details.jpeg)
...
![Client connection completed](/sherpa-docs/assets/images/client_connection_comnpleted.jpeg)

Click the **SAVE** button and then the **NEXT** button.

All being well, you will be prompted for your Sherpa **username** and **password**.

![Client username and password](/sherpa-docs/assets/images/client_username_and_password.jpeg)
...
![Linux workstation](/sherpa-docs/assets/images/linux_workstation.jpeg)
...
![Client saved connection](/sherpa-docs/assets/images/client_saved_connection.jpeg)
...
## Logging out of your workstation
Do **not** use the disconnect option in the Teradici software. If you do, you will remain logged into your workstation, your workstation will be on and you will be charged.

When you have finished using your workstation make sure to log out or better still shut down your workstation.
