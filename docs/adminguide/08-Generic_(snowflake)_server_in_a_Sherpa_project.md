...
![add-generic-resource](/docs/images/add-generic-resource.png)

Below is an example of a project in which I have built a license server and a monitoring server.

![generic-servers](/docs/images/generic-servers.png)
...
![generic-resource-allow-list](/docs/images/generic-resource-allow-list.png)
