...
![add-generic-resource](/sherpa-docs/assets/images/add-generic-resource.png)

Below is an example of a project in which I have built a license server and a monitoring server.

![generic-servers](/sherpa-docs/assets/images/generic-servers.png)
...
![generic-resource-allow-list](/sherpa-docs/assets/images/generic-resource-allow-list.png)
