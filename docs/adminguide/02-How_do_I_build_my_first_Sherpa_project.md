...
![Create a new project](/sherpa-docs/assets/images/create-a-new-project.png)
...
![Select-born-in-the-cloud](/sherpa-docs/assets/images/select-born-in-the-cloud.png)

Give the project a **Name** and select the cloud **Provider**.

![Project name and cloud provider](/sherpa-docs/assets/images/project-name-and-cloud-provider.png)
...
![Select a location](/sherpa-docs/assets/images/select-a-location.png)
...
![Workstation build spec](/sherpa-docs/assets/images/workstation-build-spec.png)
...
![Shared storage](/sherpa-docs/assets/images/shared-storage.png)

![Render manager](/sherpa-docs/assets/images/render-manager.png)

![Render node](/sherpa-docs/assets/images/render-node.png)
...
![Updated estimate](/sherpa-docs/assets/images/updated-estimate.png)
...
![SSH key selection](/sherpa-docs/assets/images/ssh-key-selection.png)
...
![Summary page](/sherpa-docs/assets/images/summary-page-1.png)

Your project will initially go into a **Saved** state.

![Project saved](/sherpa-docs/assets/images/project-saved.png)

Shortly after it should go into a **Building** state.

![Project building](/sherpa-docs/assets/images/project-building.png)

After some time it will finish **Building** and go into a **Built** state.

![Project built](/sherpa-docs/assets/images/project-built.png)
