...
![Create a new project](/docs/images/create-a-new-project.png)
...
![Select-born-in-the-cloud](/docs/images/select-born-in-the-cloud.png)

Give the project a **Name** and select the cloud **Provider**.

![Project name and cloud provider](/docs/images/project-name-and-cloud-provider.png)
...
![Select a location](/docs/images/select-a-location.png)
...
![Workstation build spec](/docs/images/workstation-build-spec.png)
...
![Shared storage](/docs/images/shared-storage.png)

![Render manager](/docs/images/render-manager.png)

![Render node](/docs/images/render-node.png)
...
![Updated estimate](/docs/images/updated-estimate.png)
...
![SSH key selection](/docs/images/ssh-key-selection.png)
...
![Summary page](/docs/images/summary-page-1.png)

Your project will initially go into a **Saved** state.

![Project saved](/docs/images/project-saved.png)

Shortly after it should go into a **Building** state.

![Project building](/docs/images/project-building.png)

After some time it will finish **Building** and go into a **Built** state.

![Project built](/docs/images/project-built.png)
