...
![Autodesk Flame](/sherpa-docs/assets/images/autodesk-flame.png)

The minimal recommended size for a Flame workstation is a **T4-1-32-128** as shown in the image above.

If you would like to be using Flame in Sherpa, please contact us at <sherpa@escape-technology.com>.
