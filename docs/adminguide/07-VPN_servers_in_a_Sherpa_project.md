...
![project-ssh-key](/sherpa-docs/assets/images/project-ssh-key.png)
...
![add-vpn](/sherpa-docs/assets/images/add-vpn.png)

Give it a suitable name, select the _Remote Access VPN_ build profile and select an appropriate size.

![add-remote-access-vpn](/sherpa-docs/assets/images/add-remote-access-vpn.png)
...
![ra-vpn-created](/sherpa-docs/assets/images/ra-vpn-created.png)
...
![allowed-ip-addresses-wg](/sherpa-docs/assets/images/allowed-ip-addresses-wg.png)
...
![add-vpn-ip](/sherpa-docs/assets/images/add-vpn-ip.png)
...
![ra-vpn-private-ip](/sherpa-docs/assets/images/ra-vpn-private-ip.png)
...
![manage-wireguard-tunnels](/sherpa-docs/assets/images/manage-wireguard-tunnels.png)

In the bottom left-hand corner select, _Add Empty Tunnel..._

![add-empty-tunnel](/sherpa-docs/assets/images/add-empty-tunnel.png)
...
![add-tunnel-details](/sherpa-docs/assets/images/add-tunnel-details.png)

You will now have an new entry in the list of tunnels.

![tunnel-details-added](/sherpa-docs/assets/images/tunnel-details-added.png)
...
![tunnel-activated-and-passing-data](/sherpa-docs/assets/images/tunnel-activated-and-passing-data.png)
...
![tunnel-failure](/sherpa-docs/assets/images/tunnel-failure.png)
