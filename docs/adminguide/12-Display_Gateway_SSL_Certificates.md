...
![display-gateway-resource-details](/docs/images/display-gateway-resource-details.png)
...
![add-display-gateways](/docs/images/add-display-gateways.png)
...
![add-display-gateways-detail](/docs/images/add-display-gateways-detail.png)

Press **Create** and the new Display Gateway will go through the normal Saved, Building and Built stages as illustrated below.

Saved
![new-display-gateway-saved](/docs/images/new-display-gateway-saved.png)

Building
![new-display-gateway-building](/docs/images/new-display-gateway-building.png)

Built
![new-display-gateway-built](/docs/images/new-display-gateway-built.png)
...
![new-display-gateway-details](/docs/images/new-display-gateway-details.png)
