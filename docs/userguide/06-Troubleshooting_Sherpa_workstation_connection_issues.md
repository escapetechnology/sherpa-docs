...
![Connect Insecurely](/docs/images/connect-insecurely.png)
...
![Unable to connect](/docs/images/unable-to-connect.png)
...
![The network connection has been lost](/docs/images/the-network-connection-has-been-lost.png)
...
![This desktop has no sources available](/docs/images/this-desktop-has-no-sources-available.png)
...
![You are not entitled to any resource](/docs/images/you_are_not_entitled.jpeg)
...
![Authentication failed](/docs/images/authentication-failed.png)
...
![No local account on workstation](/docs/images/no-local-account-on-workstation.png)
...
![Not been invited](/docs/images/not-been-invited.png)
...
![The workstation was stopped](/docs/images/the-workstation-was-stopped.png)
...
![Non-startable state](/docs/images/non-startable-state.png)
...
![Error 6609](/docs/images/error-6609.png)

![Error 6405](/docs/images/error-6405.png)
...
![Delete saved connection](/docs/images/delete-saved-connection.png)
...
![No available licenses](/docs/images/no-available-licenses.png)
...
![Error 6610](/docs/images/error_6610.png)
