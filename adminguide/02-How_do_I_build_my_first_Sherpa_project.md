...
![Create a new project]({{config.baseurl}}/images/create-a-new-project.png)
...
![Select-born-in-the-cloud]({{config.baseurl}}/images/select-born-in-the-cloud.png)

Give the project a **Name** and select the cloud **Provider**.

![Project name and cloud provider]({{config.baseurl}}/images/project-name-and-cloud-provider.png)
...
![Select a location]({{config.baseurl}}/images/select-a-location.png)
...
![Workstation build spec]({{config.baseurl}}/images/workstation-build-spec.png)
...
![Shared storage]({{config.baseurl}}/images/shared-storage.png)

![Render manager]({{config.baseurl}}/images/render-manager.png)

![Render node]({{config.baseurl}}/images/render-node.png)
...
![Updated estimate]({{config.baseurl}}/images/updated-estimate.png)
...
![SSH key selection]({{config.baseurl}}/images/ssh-key-selection.png)
...
![Summary page]({{config.baseurl}}/images/summary-page-1.png)

Your project will initially go into a **Saved** state.

![Project saved]({{config.baseurl}}/images/project-saved.png)

Shortly after it should go into a **Building** state.

![Project building]({{config.baseurl}}/images/project-building.png)

After some time it will finish **Building** and go into a **Built** state.

![Project built]({{config.baseurl}}/images/project-built.png)
