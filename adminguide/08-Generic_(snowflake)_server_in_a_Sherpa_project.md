...
![add-generic-resource]({{config.baseurl}}/images/add-generic-resource.png)

Below is an example of a project in which I have built a license server and a monitoring server.

![generic-servers]({{config.baseurl}}/images/generic-servers.png)
...
![generic-resource-allow-list]({{config.baseurl}}/images/generic-resource-allow-list.png)
