...
![request-image-creation]({{config.baseurl}}/images/request-image-creation.png)

A new window will appear.
![request-image-creation-details]({{config.baseurl}}/images/request-image-creation-details.png)
...
![images-menu]({{config.baseurl}}/images/images-menu.png)

You will be presented with a list of images.
![image-list]({{config.baseurl}}/images/image-list.png)
...
![images-in-cost-reports]({{config.baseurl}}/images/images-in-cost-reports.jpg)
...
![request-image-copy]({{config.baseurl}}/images/request-image-copy.png)
...
![request-image-deletion]({{config.baseurl}}/images/request-image-deletion.png)
