...
![request-image-creation](/sherpa-docs/images/request-image-creation.png)

A new window will appear.
![request-image-creation-details](/sherpa-docs/images/request-image-creation-details.png)
...
![images-menu](/sherpa-docs/images/images-menu.png)
...
![images-as-build-profiles](/sherpa-docs/images/images-as-build-profiles.png)

## Checking the ongoing cost of an image

The current/ongoing costs for an image can be shown for the current week.

![image-ongoing-costs](/sherpa-docs/images/image-ongoing-costs.jpg)
...
![images-in-cost-reports](/sherpa-docs/images/images-in-cost-reports.jpg)
...
![request-image-copy](/sherpa-docs/images/request-image-copy.png)
...
![request-image-deletion](/sherpa-docs/images/request-image-deletion.png)
