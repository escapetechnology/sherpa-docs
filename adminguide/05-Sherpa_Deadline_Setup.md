...
![worker-settings](/sherpa-docs/images/worker-settings.png)
...
![pulse-settings](/sherpa-docs/images/pulse-settings.png)
...
![pulse-power-management](/sherpa-docs/images/pulse-power-management.png)

### Options

Under _Tools -> Options_ ...

![options](/sherpa-docs/images/options.png)

Make sure _Enable Worker Pinging_ box is ticked.

![enable-worker-ping](/sherpa-docs/images/enable-worker-ping.png)
...
![configure-events](/sherpa-docs/images/configure-events.png)

### Disable AWSPortal

Disable AWS Portal by setting the _State_ to be _Disabled_.

![disable-aws-portal](/sherpa-docs/images/disable-aws-portal.png)
...
![configure-sherpa-event-plugin](/sherpa-docs/images/configure-sherpa-event-plugin.png)

### Configure Power Management

Select _Tools -> Configure Power Management ..._

![configure-power-management](/sherpa-docs/images/configure-power-management.png)
...
![add-power-management-group](/sherpa-docs/images/add-power-management-group.png)
...
![configure-idle-shutdown](/sherpa-docs/images/configure-idle-shutdown.png)
...
![configure-machine-startup](/sherpa-docs/images/configure-machine-startup.png)
...
![idle-shutdown-01](/sherpa-docs/images/idle-shutdown-01.png)

Zooming in on some of the important detail from the screen-grab above ...

A. The render node is on-line and pingable.
![idle-shutdown-01a](/sherpa-docs/images/idle-shutdown-01a.png)
...
![idle-shutdown-01b](/sherpa-docs/images/idle-shutdown-01b.png)
...
![idle-shutdown-02a](/sherpa-docs/images/idle-shutdown-02a.png)
...
![idle-shutdown-03](/sherpa-docs/images/idle-shutdown-03.png)

So 5 minutes later the render node turns red and gets marked as _Stalled_ (or _Offline_).
![idle-shutdown-03a](/sherpa-docs/images/idle-shutdown-03a.png)
