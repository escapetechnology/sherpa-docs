...
![otp-email]({{config.baseurl}}/images/otp-email.png)

Paste the verification code from the email into the OTP box and then press LOGIN.

![otp-phase3]({{config.baseurl}}/images/otp-phase3.png)
