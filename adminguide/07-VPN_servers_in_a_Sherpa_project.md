...
![project-ssh-key](/sherpa-docs/images/project-ssh-key.png)
...
![add-vpn](/sherpa-docs/images/add-vpn.png)

Give it a suitable name, select the _Remote Access VPN_ build profile and select an appropriate size.

![add-remote-access-vpn](/sherpa-docs/images/add-remote-access-vpn.png)
...
![ra-vpn-created](/sherpa-docs/images/ra-vpn-created.png)
...
![allowed-ip-addresses-wg](/sherpa-docs/images/allowed-ip-addresses-wg.png)
...
![add-vpn-ip](/sherpa-docs/images/add-vpn-ip.png)
...
![ra-vpn-private-ip](/sherpa-docs/images/ra-vpn-private-ip.png)
...
![manage-wireguard-tunnels](/sherpa-docs/images/manage-wireguard-tunnels.png)

In the bottom left-hand corner select, _Add Empty Tunnel..._

![add-empty-tunnel](/sherpa-docs/images/add-empty-tunnel.png)
...
![tunnel-activated-and-passing-data](/sherpa-docs/images/tunnel-activated-and-passing-data.png)
...
![tunnel-failure](/sherpa-docs/images/tunnel-failure.png)
