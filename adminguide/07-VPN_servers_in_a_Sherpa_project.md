...
![project-ssh-key]({{config.baseurl}}/images/project-ssh-key.png)
...
![add-vpn]({{config.baseurl}}/images/add-vpn.png)

Give it a suitable name, select the _Remote Access VPN_ build profile and select an appropriate size.

![add-remote-access-vpn]({{config.baseurl}}/images/add-remote-access-vpn.png)
...
![ra-vpn-created]({{config.baseurl}}/images/ra-vpn-created.png)
...
![allowed-ip-addresses-wg]({{config.baseurl}}/images/allowed-ip-addresses-wg.png)
...
![add-vpn-ip]({{config.baseurl}}/images/add-vpn-ip.png)
...
![ra-vpn-private-ip]({{config.baseurl}}/images/ra-vpn-private-ip.png)
...
![manage-wireguard-tunnels]({{config.baseurl}}/images/manage-wireguard-tunnels.png)

In the bottom left-hand corner select, _Add Empty Tunnel..._

![add-empty-tunnel]({{config.baseurl}}/images/add-empty-tunnel.png)
...
![add-tunnel-details]({{config.baseurl}}/images/add-tunnel-details.png)

You will now have a new entry in the list of tunnels.

![tunnel-details-added]({{config.baseurl}}/images/tunnel-details-added.png)
...
![tunnel-activated-and-passing-data]({{config.baseurl}}/images/tunnel-activated-and-passing-data.png)
...
![tunnel-failure]({{config.baseurl}}/images/tunnel-failure.png)
