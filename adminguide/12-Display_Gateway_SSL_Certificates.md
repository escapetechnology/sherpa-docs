...
![display-gateway-resource-details](/images/display-gateway-resource-details.png)
...
![add-display-gateways](/images/add-display-gateways.png)
...
![add-display-gateways-detail](/images/add-display-gateways-detail.png)

Press **Create** and the new Display Gateway will go through the normal Saved, Building and Built stages as illustrated below.

Saved
![new-display-gateway-saved](/images/new-display-gateway-saved.png)

Building
![new-display-gateway-building](/images/new-display-gateway-building.png)

Built
![new-display-gateway-built](/images/new-display-gateway-built.png)
...
![new-display-gateway-details](/images/new-display-gateway-details.png)
