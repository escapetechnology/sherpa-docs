...
![storage-inbound-rules]({{config.baseurl}}/images/storage-inbound-rules.png)
...
![display-gateway-inbound-rules]({{config.baseurl}}/images/display-gateway-inbound-rules.png)
...
![workstation-inbound-rules]({{config.baseurl}}/images/workstation-inbound-rules.png)
